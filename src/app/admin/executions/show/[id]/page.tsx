          ...
          <Card loading={query?.isLoading} bodyStyle={{ display: 'flex', flexDirection: 'column' }} style={{ height: '100%' }}>
            ...
            {record && (
              <Descriptions bordered column={1} size="middle">
                ...
                <Descriptions.Item label="Created At">{dayjs.utc(record.created_at).tz('Asia/Seoul').format('YYYY-MM-DD HH:mm:ss [KST]')}</Descriptions.Item>
              </Descriptions>
            )}
            {record?.steps && (
              <div style={{ marginTop: 16, overflow: 'auto' }}>
                ...
                <Table
                  ...
                  columns={[
                    ...
                    { title: 'Started', dataIndex: 'started_at', render: (v: string) => v ? dayjs.utc(v).tz('Asia/Seoul').format('YYYY-MM-DD HH:mm:ss [KST]') : '-' },
                    { title: 'Completed', dataIndex: 'completed_at', render: (v: string) => v ? dayjs.utc(v).tz('Asia/Seoul').format('YYYY-MM-DD HH:mm:ss [KST]') : '-' },
